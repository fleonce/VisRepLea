...
def fid_over_time(
    ...
    if model == "inceptionv3":
        if dataset == "cifar10":
            ...
            clip = torch.tensor([35.00402840878229, 29.92497773620704, 25.85683240706402, 24.101429289544456, 23.344319357348297, 24.01698646261167, 23.156319003575675, 22.464465777922044])
            ijepa = torch.tensor([26.47907955176248, 20.124762187296085, 16.914779437759023, 15.531677249700863, 14.990195188937264, 14.85231876096043, 13.918775451683757, 13.728435742051772])
        ...
        if dataset == "imagenet":
            clip = torch.tensor([483.6327177186031, 398.37649185707915, 345.71003124376693, 319.4035108013868, 316.12718639328614, 315.63490494021016, 302.09806392134124, 298.62032606066896])
            ijepa = torch.tensor([353.0907041265755, 272.19966455823305, 235.78038411127727, 221.99693286199363, 216.6956576528064, 213.94503570488132, 205.46539213718825, 201.5517595200431])
            labels = [10, 20, 30, 40, 50, 60, 70, 80]
